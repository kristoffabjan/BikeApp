...
Route::delete('/destroyBikeRate/{rate}',[BikeRateController::class, 'destroy'])->name('destroy.bike.rate');
...
Route::delete('/deleteShop/{shop}', [ShopsController::class, 'destroy'])->name('delete.shop');
...
Route::delete('/destroyShopRate/{rate}',[ShopRateController::class, 'destroy'])->name('destroy.shop.rate');
...
Route::delete('/destroy/{test}',[TestController::class, 'destroy'])->name('delete.test');
...
Route::delete('/deleteBike/{bike}', [BikeController::class, 'destroy'])->name('delete.bike');
...
Route::delete('/bikeToShop/{shop}/bike/{bike}', [BikesAtShopContoller::class, 'destroyEntry'])->name('bikeToShop.destroy');
